...
### dependency vars
random_state = 42
tfidf_m = np.load('/home/datallah/datallah-jaymefis-gibsonce/bgmm/tfidf_trunc_low_dim.npy')
tfidf_m_val = np.load('/home/datallah/datallah-jaymefis-gibsonce/bgmm/tfidf_trunc_val_low_dim.npy')

# init variables
max_components = list(np.arange(10, 30 + 1, 10))
# lst.append(1)
# max_components = sorted(lst)
num_threads = 4

# init empty results df
doc_path = '/home/datallah/datallah-jaymefis-gibsonce/bgmm/large_step_sensitivity_low_dim.csv'
